                ...
                foreach (var data in datas)
                {
                    ...
                    foreach (var prop in properties)
                    {
                        ...
                        switch (j)
                        {
                            case 1:
                                {
                                    workSheet.Cells[i, j].Value = data.assetid;
                                    break;
                                }
                            case 2:
                                {
                                    workSheet.Cells[i, j].Value = data.assetcode;
                                    break;
                                }
                            case 3:
                                {
                                    workSheet.Cells[i, j].Value = data.assetname;
                                    break;
                                }
                            case 4:
                                {
                                    workSheet.Cells[i, j].Value = data.description;
                                    break;
                                }
                            case 5:
                                {
                                    workSheet.Cells[i, j].Value = data.thumbnail;
                                    break;
                                }
                            case 6:
                                {
                                    workSheet.Cells[i, j].Value = data.status;
                                    break;
                                }
                            case 7:
                                {
                                    workSheet.Cells[i, j].Value = data.price;
                                    break;
                                }
                            case 8:
                                {
                                    workSheet.Cells[i, j].Value = data.quantity;
                                    break;
                                }
                            case 9:
                                {
                                    workSheet.Cells[i, j].Value = data.boughtat;
                                    break;
                                }
                            case 10:
                                {
                                    workSheet.Cells[i, j].Value = data.warrantyto;
                                    break;
                                }
                            case 11:
                                {
